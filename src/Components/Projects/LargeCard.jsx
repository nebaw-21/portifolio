...
<div className="p-4 md:p-0">
    ...
    <div className="flex flex-col md:flex-row gap-8 p-4 mt-4 text-black rounded-2xl shadow-xl overflow-hidden border border-gray-700 transition-all  hover:shadow-2xl  max-w-5xl mx-auto">
      {/* Image Section */}
      ...
      <div className="flex flex-col gap-4 w-full md:w-2/3 text-center">
        <h1 className="text-3xl font-extrabold tracking-wide text-black">Project Title</h1>
