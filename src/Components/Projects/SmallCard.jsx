...
<div className="p-4 md:p-0">
    ...
    <div className="flex flex-col gap-4 p-4 mt-4 text-black rounded-2xl shadow-xl overflow-hidden border border-gray-700 transition-all  hover:shadow-2xl w-[400px] mx-auto">
      {/* Image Section */}
